package com.crowdo.p2pmobile.custom_ui;
...
public class GoalProgressBar extends View{
    ...
    private void init(AttributeSet attrs){
        ...
        try{
            ...
            setAnimateDuration(typedArray.getInteger(R.styleable.GoalProgressBar_animateDuration, 700));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int progressEndX = (int) (getWidth() * this.progress / 100f);
        ...
        // draw unfilled portion of the bar
    ...
    public void setProgress(final int progress, boolean animate) {
        ...
        if(animate){
            ...
            barAnimator.setDuration(this.animateDuration);

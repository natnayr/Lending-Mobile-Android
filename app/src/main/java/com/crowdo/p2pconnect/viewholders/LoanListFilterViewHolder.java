...
public class LoanListFilterViewHolder {
    ...
    @BindView(R2.id.loan_list_view_filtering_term_3_button) LinearLayout term3Button;
    @BindView(R2.id.loan_list_view_filtering_term_4_button) LinearLayout term4Button;
    @BindView(R2.id.loan_list_view_filtering_term_5_button) LinearLayout term5Button;
    @BindView(R2.id.loan_list_view_filtering_term_6_button) LinearLayout term6Button;
    @BindView(R2.id.loan_list_view_filtering_term_9_button) LinearLayout term9Button;
    @BindView(R2.id.loan_list_view_filtering_term_3_switch) SwitchIconView term3SwitchIconView;
    @BindView(R2.id.loan_list_view_filtering_term_4_switch) SwitchIconView term4SwitchIconView;
    @BindView(R2.id.loan_list_view_filtering_term_5_switch) SwitchIconView term5SwitchIconView;
    @BindView(R2.id.loan_list_view_filtering_term_6_switch) SwitchIconView term6SwitchIconView;
    @BindView(R2.id.loan_list_view_filtering_term_9_switch) SwitchIconView term9SwitchIconView;

    @BindView(R2.id.loan_list_view_filtering_grade_Aplus_button) LinearLayout gradeAPlusButton;
    @BindView(R2.id.loan_list_view_filtering_grade_A_button) LinearLayout gradeAButton;
    @BindView(R2.id.loan_list_view_filtering_grade_Bplus_button) LinearLayout gradeBPlusButton;
    @BindView(R2.id.loan_list_view_filtering_grade_B_button) LinearLayout gradeBButton;
    @BindView(R2.id.loan_list_view_filtering_grade_C_button) LinearLayout gradeCButton;
    @BindView(R2.id.loan_list_view_filtering_grade_D_button) LinearLayout gradeDButton;
    @BindView(R2.id.loan_list_view_filtering_grade_E_button) LinearLayout gradeEButton;
    @BindView(R2.id.loan_list_view_filtering_grade_Aplus_checkbox) AnimateCheckBox gradeAPlusCheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_A_checkbox) AnimateCheckBox gradeACheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_Bplus_checkbox) AnimateCheckBox gradeBPlusCheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_B_checkbox) AnimateCheckBox gradeBCheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_C_checkbox) AnimateCheckBox gradeCCheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_D_checkbox) AnimateCheckBox gradeDCheckBox;
    @BindView(R2.id.loan_list_view_filtering_grade_E_checkbox) AnimateCheckBox gradeECheckBox;

    @BindView(R2.id.loan_list_view_filtering_security_collateralized_button) LinearLayout securityCollaterialisedButton;
    @BindView(R2.id.loan_list_view_filtering_security_uncollateralized_button) LinearLayout securityUncollaterialisedButton;
    @BindView(R2.id.loan_list_view_filtering_security_work_order_invoice_button) LinearLayout securityWorkOrderInvoiceButton;
    @BindView(R2.id.loan_list_view_filtering_security_collateralized_switch) SwitchIconView securityCollaterialisedSwitch;
    @BindView(R2.id.loan_list_view_filtering_security_uncollateralized_switch) SwitchIconView securityUncollaterialisedSwitch;
    @BindView(R2.id.loan_list_view_filtering_security_work_order_invoice_switch) SwitchIconView securityWorkOrderInvoiceSwitch;
    @BindView(R2.id.loan_list_view_filtering_security_collateralized_label) TextView securityCollaterialisedLabel;
    @BindView(R2.id.loan_list_view_filtering_security_uncollateralized_label) TextView securityUncollaterialisedLabel;
    @BindView(R2.id.loan_list_view_filtering_security_work_order_invoice_label) TextView securityWorkOrderInvoiceLabel;

    @BindString(R2.string.gradeA_plus) String gradeAPlus;
    @BindString(R2.string.gradeA) String gradeA;
    @BindString(R2.string.gradeB_plus) String gradeBPlus;
    @BindString(R2.string.gradeB) String gradeB;
    @BindString(R2.string.gradeC) String gradeC;
    @BindString(R2.string.gradeD) String gradeD;
    @BindString(R2.string.gradeE) String gradeE;

    @BindColor(R2.color.color_divider_dark) int colorDividerDark;
    @BindColor(R2.color.color_primary_text) int colorPrimaryText;

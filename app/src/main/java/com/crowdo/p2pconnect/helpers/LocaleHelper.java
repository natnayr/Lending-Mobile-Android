...
public class LocaleHelper {
    ...
    private static String getPersistentData(Context context, String defaultLanguage){
        ...
        return preferences.getString(ConstantVariables.PREF_KEY_SELECTED_LANGUAGE, defaultLanguage);
    }

    private static void persist(Context context, String language){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(ConstantVariables.PREF_KEY_SELECTED_LANGUAGE, language);
        editor.apply();
    }

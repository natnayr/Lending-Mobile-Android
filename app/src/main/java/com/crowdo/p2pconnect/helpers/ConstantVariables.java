...
public class ConstantVariables {
    ...
    public static final String TOPUP_CONFIRM = "confirmed";
    public static final String TOPUP_PENDING = "pending";
    public static final String TOPUP_CANCELLED = "cancelled";

...
public class ConstantVariables {
    ...
    public static final String WALLET_CONFIRM = "confirmed";
    public static final String WALLET_PENDING = "pending";
    public static final String WALLET_CANCELLED = "cancelled";

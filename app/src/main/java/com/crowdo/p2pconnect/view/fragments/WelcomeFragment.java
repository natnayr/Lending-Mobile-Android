...
public class WelcomeFragment extends Fragment implements MediaPlayer.OnPreparedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_welcome, parent, false);
        ButterKnife.bind(this, rootView);

        videoUri = Uri.parse("android.resource://" +
                getActivity().getPackageName() + "/"
                + R.raw.crowdo_video_phone);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mHolder.addCallback(new SurfaceHolder.Callback() {
                ...
                public void surfaceCreated(SurfaceHolder holder) {
                    ...
                    try {
                        mPlayer.setDataSource(getActivity(), videoUri);
                        mPlayer.setOnPreparedListener(WelcomeFragment.this);
                        mPlayer.prepare();
        ...
        mViewPager.setAdapter(new WelcomePagerAdapter(getActivity()));

        Typeface nycdTypeFace = TypefaceUtils.getNothingYouCouldDoTypeFace(getActivity());
